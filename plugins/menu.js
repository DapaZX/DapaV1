...
✮ yt: https://youtube.com/channel/UCMfqoj1vq3XDUKjlkL_fTKA
✮ Grup Wa Bot: *https://chat.whatsapp.com/HwiccfZVPqN7yEbEaUEkh2*
...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    await conn.sendButton(m.chat, text.trim(), '© Dapa Maker', {"button[0]": 'Owner', "row[0]": '.owner'}, m, { mentions: [m.sender] })
  } catch (e) {
